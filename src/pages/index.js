...
const IndexPage = ({ siteTitle }) => {
  return (
    <Layout title={siteTitle}>
      ...
      <article className="mb-16 container overflow-x-hidden height-100 md:flex lg:flex-col lg:justify-center lg:items-start">
        <header className="xl:max-w-2xl">
          <div className="relative">
            <Image className="mx-auto w-3/4 md:w-1/2 hero-image" />
          </div>
          ...
          <h2 className="mt-8 text-lg lg:max-w-2xl leading-relaxed">
            You're wasting time with unnecessary, unusable design. <br /> Learn
            how to solve user experience problems that top companies{" "}
