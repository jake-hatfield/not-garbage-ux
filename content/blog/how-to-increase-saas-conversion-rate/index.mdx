...
description: "Keyword Research for SEO: The
Definitive Guide (2020)Keyword Research for SEO: The
Definitive Guide (2020)Keyword Research for SEO: The
Definitive Guide (2020)Keyword Research for SEO: The
Definitive Guide (2020)Keyword Research for SEO: The
Definitive Guide (2020)Keyword Research for SEO: The
Definitive Guide (2020)"
shortDescription: 'This is a much shorter description'
topic: 'SaaS CRO'
twitterTags: ['saasCRO', 'baconandeggs']
featuredImage: ./conversion-spectrum.jpg
author: "Jake Hatfield"
---

# How to Increase SaaS Conversion Rate Using Cold-War Science and UX Minimalism

# slug: https://www.notgarbageux.com/how-to-increase-saas-conversion-rate
...
Software-as-a-service (SaaS) founders, UX designers, and marketers need to know that user acquisition quality matters significantly more that product quality. Converting customers is important, yes; but in a recurring revenue business model, converting the right customers is even more important.

In this article, I compiled and analyzed the websites of 97 SaaS companies to help you understand the importance of user acquisition quality. I wanted to figure out the goal of each site in its attempt to convert their ideal customer.
...
First, let's talk about why SaaS conversion rate optimization (CRO) is uniquely difficult compared to traditional CRO.
...
In your nightmare scenario, your user cancels after their first month. If your conversion rate is 1%, then your one-month-chump of a user canceling makes it like 100 people never went to your website. Strike them from the analytics, it was all just a prank.
...
For instance, 99% of the sites in this case study used a light theme
...
A little later in the article, I'll discuss my more significant research insights regarding UX consistency and Jakob's Law so as to not put an unnecessary strain on your users. Stay tuned...
...
Unfortunately, we live in the real world. Your website needs to have certain elements to convince users to buy. It would be absurd to say "Your SaaS sales page needs to be at least 700 words with 4 testimonials, 2 videos, and and many svgs as we can fit. Lots of white space. Users go nuts for white space."

The fundamental issue we're trying to solve is one of trust. A trust disparity exists between your product and your customer; at the root of the problem is their lack of belief that you can solve the issue they need help with.
...
With these three concepts in mind, we can construct a set of questions to keep us on track. These questions are in no particular order since every customer is in a different stage of the buying cycle.
...
This over-arching framework is great for high-level evaluation, so keep them in the back of your mind; but now we'll learn the practical ways to optimize your conversion rate.
...
done \_**\_ Tertiary action example from case study research \_\_**
...
done \_**\_ CTA word pie chart \_\_**
...
Every single element on the page, from the navigation links to the media assets, should be scrutinized to support your primary action. From top to bottom, go through the page and follow the flowchart below.
...
done \_**\_ Testimonial Carousel \_\_**

Elements like carousels don't provide as much value to your user as you might expect. I understand you think that an infinite loop of your three testimonials makes you look more popular than you actually are, but it's counter-productive. Carousels that animate in and out can be frustrating to consume if they animate out in the middle of being read.
...
done \_**\_ Testimonial Updated \_\_**
...
done \_**\_ 3 pricing plans \_\_**

with a minimum of 1

done \_**\_ 1 pricing plan \_\_**

and a maximum of 9.

done \_**\_ 9 pricing plans \_\_**

Surprisingly, only 1/3 of the pricing pages had annual plans.

done \_**\_ annual plan toggle \_\_**
...
A common theme I saw in my analysis was to have the basic information contained in a card per plan

done \_**\_ pricing cards \_\_**
...
done \_**\_ headers and checkmarks \_\_**

Some sites included a "+" button that provided more information about each feature.

done \_**\_ plus sign - https://www.bamboohr.com/pricing/ \_\_**
...
\_**\_ regular testimonial example \_\_**

but they were used in a unique way by Convertri

\_**\_ convertri screenshot \_\_**

If you have a sales team, it can be powerful to offer an option to demo the product (20% of these pages gave that alternative).

## Wrapping up your process
