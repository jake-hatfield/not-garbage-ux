...
bulletDescription: "You'll Learn: <ul><li>The advantages of UX minimialism</li><li>How to apply scientific design principles</li><li>Software website trends from top companies</li></ul>"
...
<section className="bg-gray-200 full-width">
  <div className="mt-8 py-8 container md:max-w-xl lg:max-w-2xl">
    ...
    <div className="mt-8 flex flex-col-reverse md:flex md:flex-row md:justify-between">
      <div>
        <p className="mt-5 md:mt-0">laksdfjadslkfjasdlkfj lkajsdf lksadjf</p>
        <p className="mt-5">laksdfjadslkfjasdlkfj lkajsdf lksadjf</p>
        <p className="mt-5">laksdfjadslkfjasdlkfj lkajsdf lksadjf</p>
      </div>
      <div className="md:ml-6">
        <img src="./SaaS-CRO-Hero.svg" className="mb-0 md:w-64" />
      </div>
    </div>
  </div>
</section>
...
<section className="bg-gray-200 full-width">
  <div className="mt-8 py-8 container md:max-w-xl lg:max-w-2xl">
    ...
    <div className="mt-8 flex flex-col-reverse md:flex md:flex-row md:justify-between">
      <div>
        <p className="mt-5 md:mt-0">laksdfjadslkfjasdlkfj lkajsdf lks</p>
        <p className="mt-5">laksdfjadslkfjasdlkfj lkajsdf lksadjf</p>
        <p className="mt-5">laksdfjadslkfjasdlkfj lkajsdf lksadjf</p>
      </div>
      <div className="md:ml-6">
